...
IlbmHandler::IlbmHandler(ILcontext* context) :
	context(context)
{

}

ILboolean IlbmHandler::isValid(ILconst_string FileName)
{
	ILHANDLE    f;
...
ILboolean IlbmHandler::isValidF(ILHANDLE File)
{
	ILuint      FirstPos;
	ILboolean   bRet;
...
ILboolean IlbmHandler::isValidL(const void *Lump, ILuint Size)
{
	iSetInputLump(context, Lump, Size);
	return isValidInternal();
}

ILboolean IlbmHandler::isValidInternal()
{
	return isLBM(context) ? IL_TRUE : IL_FALSE;
}

// Reads a file
ILboolean IlbmHandler::load(ILconst_string FileName)
{
	ILHANDLE    IlbmFile;
	ILboolean   bIlbm = IL_FALSE;
...
ILboolean IlbmHandler::loadF(ILHANDLE File)
{
	ILuint      FirstPos;
	ILboolean   bRet;
...
ILboolean IlbmHandler::loadL(const void *Lump, ILuint Size)
{
	iSetInputLump(context, Lump, Size);
	return loadInternal();
}

ILboolean IlbmHandler::loadInternal()
{
